...
// Обнуление элементов матрицы, лежащих одновременно ниже главной диагонали (включая эту диагональ) и выше побочной диагонали (также включая эту диагональ):
...
int main(int argc, char *argv[]) {
	...
	zeromat(mat, m, n);  // обнуление элементов матрицы, лежащих одновременно ниже главной диагонали (включая эту диагональ) и выше побочной диагонали (также включая эту диагональ).
